...
namespace IRO_UNMO.App.Areas.Admin.Controllers
{
    ...
    public class TimingController : Controller
    {
        ...
        public TimingController(ApplicationDbContext db, IHostingEnvironment environment, UserManager<ApplicationUser> userManager,
        ...
        public IActionResult timing(TimingVM vm)
        {
            ...
            return RedirectToAction("index", "timing", new { area = "admin" });
        }
    }
}